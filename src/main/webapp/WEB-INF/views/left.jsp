...
<body>
	<div style="margin:10px;background-color:#FFFFFF; text-align:left;">
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <tr valign="top" id="submenu2" style="display: none">
		    <td class="left_nav_bgshw" height="50">
			  ...
			  <%--<p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="job/addJob?flag=1" target="main">添加职位</a></img></p>--%>
				<p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="job/addJob" target="main">添加职位</a></img></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		  ...
		  <tr><td id="navbg5" class="left_nav_closed"><div class="font1">文档管理</div></td></tr>
		  <tr valign="top" id="submenu5" style="display: none">
			...
			<tr><td id="navbg6" class="left_nav_closed"><div class="font1">培训管理</div></td></tr>
			<tr valign="top" id="submenu6" style="display: none">
				<td class="left_nav_bgshw tdbtmline" height="50">
					<p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/train/selectTrain" target="main">培训查询</a></img></p>
					<p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/train/addTrain?" target="main">添加培训</a></img></p>
				</td>
			</tr>
		  <tr><td height="2"></td></tr>
