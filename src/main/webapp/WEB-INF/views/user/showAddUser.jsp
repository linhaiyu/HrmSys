		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		...
		    		<tr>
		    			<td class="font3 fftd">登录名：<input type="text" name="loginName" id="loginName" size="20" /></td>
		    			<td class="font3 fftd">密&nbsp;码：<input type="text" name="password" id="password" size="20" /></td>
		    		</tr>
