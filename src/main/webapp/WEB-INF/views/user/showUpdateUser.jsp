...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
        ...
        <td>
            <form action="${ctx}/user/updateUser" id="updateUserForm" method="post">
                <%--<input type="hidden" name="flag" value="2">--%>
                <input type="hidden" name="id" id="id" value="${user.id }" />
                姓名：<input type="text" name="userName" id="userName" size="20" value="${user.userName }"/>
                状态：<input type="text" name="status" id="status" size="20" value="${user.status }"/>
                登录名：<input type="text" name="loginName" id="loginName" size="20" value="${user.loginName }"/>
                密码：<input type="text" name="password" id="password" size="20" value="${user.password }"/>
